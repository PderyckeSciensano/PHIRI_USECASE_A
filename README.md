# Open Notebooks produced by [PHIRI.eu](http://phiri.eu).
...
Jupyter+R: [![Binder](http://mybinder.org/badge_logo.svg)]([https://notebooks.gesis.org/binder/badge.svg](http://mybinder.org/badge_logo.svg))](https://notebooks.gesis.org/binder/v2/gh/PderyckeSciensano/PHIRI_USECASE_A/HEAD?labpath=UsecaseA.ipynb)
